  ...
  it("keeps queued sends blocked while request user input is pending", async () => {
    ...
    const { result } = renderHook(() => {
      ...
      const queued = useQueuedSend({
        ...
        startQueuedFork: threads.startQueuedFork,
        startQueuedReview: threads.startQueuedReview,
        startResume: threads.startResume,
        startQueuedCompact: threads.startQueuedCompact,
        startQueuedNew: threads.startQueuedNew,
